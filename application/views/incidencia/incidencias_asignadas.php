...
<?php foreach($incidencias as $i): ?>
      ...
      <div class="panel-body">
        ...
        <div class="col-md-2">
          <button type="button" class="btn btn-warning btn-block btnasginar" data="<?php echo $i['id']; ?>" data-toggle="modal" data-target="#asignarmodal">Re-Asignar</button>
...
<div class="modal fade" id="asignarmodal" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <?php endforeach; ?>
          <?php echo form_open('incidencia/reasignar_incidencia',array("class"=>"form-horizontal")); ?>
